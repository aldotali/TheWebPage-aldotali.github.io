...
/**
 * Program name: Lab03b
 * Description: This program takes the lengths checks ýf they are sýdes of a triangle of the sides of a garden (triangle) and finds the maximum number of flowers that can be planted in the garden .
